...
This project is indexed by GitNexus as **tourkit-crm** (6126 symbols, 40010 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
