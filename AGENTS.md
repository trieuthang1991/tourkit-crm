...
This project is indexed by GitNexus as **tourkit-crm** (7286 symbols, 51084 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
