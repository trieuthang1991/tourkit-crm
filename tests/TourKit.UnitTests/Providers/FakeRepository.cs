...
/// thì query non-tracking khác không thấy) — để service test được các luồng đọc-trước-khi-lưu
/// (vd recompute tổng dựa trên các dòng ĐÃ lưu + dòng mới) đúng như hành vi thật.
/// </summary>
