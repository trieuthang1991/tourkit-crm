...
/// <summary>Bộ lọc HH theo loại khách: loại khách (Code) · trạng thái · từ khoá. Status: 1 áp dụng, 0 tạm ngừng.</summary>
public sealed record CustomerCommissionRuleListFilter(int? CustomerType = null, int? Status = null, string? Q = null);
