...
namespace TourKit.Infrastructure.Migrations
{
    ...
    [Migration("20260923090058_LeadNguonChiTietVaChiaSoSale")]
    partial class LeadNguonChiTietVaChiaSoSale
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.AiInsight", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "EntityName", "EntityId", "Kind", "CreatedAt");
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.CommissionCampaign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CommissionCampaigns");
                });

            modelBuilder.Entity("TourKit.Shared.Entities.CommissionCampaignUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("CommissionCampaignId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "CommissionCampaignId");

                    b.HasIndex("TenantId", "UserId");

                    b.ToTable("CommissionCampaignUsers");
                });
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.CommissionTier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "CommissionCampaignId", "StartAmount");
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.EntityComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.FlightTicketIndividual", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AssigneeRef")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
                    ...
                    b.ToTable("FlightTicketIndividuals");
                });
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.OpportunityStage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.RoomAllotment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ProviderRef", "Date");
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.SalesOpportunity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ChildQty")
                        .HasColumnType("integer");

                    b.Property<int>("ChildSmallQty")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.SalesOpportunityAssignee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OpportunityId", "UserId", "IsFollower")
                        .IsUnique();

                    b.HasIndex("TenantId", "UserId", "IsFollower");

                    b.ToTable("SalesOpportunityAssignees");
                });
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.ServicePaymentTerm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "ServiceBookingId");

                    b.HasIndex("TenantId", "Status", "DueDate");

                    b.ToTable("ServicePaymentTerms");
                });
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.UserExternalLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.TourDeparture", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CommissionClosedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.SalesOpportunityAssignee", b =>
                {
                    b.HasOne("TourKit.Shared.Entities.SalesOpportunity", null)
                        .WithMany("Assignees")
            ...
            modelBuilder.Entity("TourKit.Shared.Entities.UserExternalLogin", b =>
                {
                    b.HasOne("TourKit.Shared.Entities.User", null)
                        .WithMany()
