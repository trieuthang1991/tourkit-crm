...
This project is indexed by GitNexus as **tourkit-crm** (5678 symbols, 36008 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
