...
This project is indexed by GitNexus as **tourkit-crm** (11787 symbols, 76769 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
