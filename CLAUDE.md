...
This project is indexed by GitNexus as **tourkit-crm** (10904 symbols, 73549 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
