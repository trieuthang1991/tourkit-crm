...
This project is indexed by GitNexus as **tourkit-crm** (6525 symbols, 43305 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
