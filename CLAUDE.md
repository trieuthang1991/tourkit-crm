...
This project is indexed by GitNexus as **tourkit-crm** (7089 symbols, 49080 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
